...
contract KittyCore is KittyMinting {
    ...
    // we've broken it up in two ways. First, we have several seperately-instantiated sibling v1
    // that handle auctions and our super-top-secret genetic combination algorithm. The auctions are
    // seperate since their logic is somewhat complex and there's always a risk of subtle bugs. By keeping
    // them in their own v1, we can upgrade them without disrupting the main contract that tracks
    ...
    //             services. The actual auction functionality is handled in two sibling v1 (one
    ...
    ///  two auction v1. (Hopefully, we can prevent user accidents.)
