...
if __name__ == '__main__':
    root_path = "/home/xcrab/MyWorkspace/testExperiments/exp2/pool-shark"
    ...
    for version in dirs:
        ...
        for id, t_file in enumerate(t_files):
            if t_file.find("try") is not -1 or t_file.find("util") is not -1 or t_file.find("helper") is not -1:
                continue
            print(version)
            petflag = False
            print("gannache")
