...
it('test 0',async() => {
await instance.addCandidate("os8Mw","OvRsC25Kli");
await instance.addCandidate("tGRdn","N6lXI28pcM");
await instance.addCandidate("AVYLP","TIgF3w0psR");
await instance.addCandidate("0RadS","Rak6SrbUoy");
await instance.addCandidate("U4VOC","eLs9a7TIBG");
await instance.addCandidate("E0ojw","BRNxqKiP4o");
await instance.addCandidate("SLvub","ig2sCImP9n");
await instance.addCandidate("fbZ15","Wgr4XJmUhG");
await instance.addCandidate("CFEGc","EMey4m1bd7");
await instance.addCandidate("AZivd","FG9VhfwI4g");
await instance.addCandidate("NAwUJ","vURKEDHwtX");
await instance.addCandidate("Kz5Qk","jS5ceYst0z");
await instance.addCandidate("qCXyZ","Z64hUHEY3p");
await instance.addCandidate("rPixg","MlNta7WiCe");
await instance.addCandidate("B80Fy","Wp5hy1Qqob");
await instance.addCandidate("5lO2M","DJ1IPVXGRc");
await instance.addCandidate("FlK36","hKJpTS2Usr");
await instance.addCandidate("dQftk","ZatTONAmcW");
await instance.addCandidate("jUd3a","ZUzVf7GHS0");
await instance.addCandidate("f5zRj","pewVoxrmt0");
