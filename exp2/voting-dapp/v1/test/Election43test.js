...
it('test 0',async() => {
await instance.addCandidate("68ByA","JfcEAmFhsj");
await instance.addCandidate("cAupt","q5IoimQPaX");
await instance.addCandidate("g4h3S","G7uBo1caFE");
await instance.addCandidate("ePDyh","OtdjU4mSrG");
await instance.addCandidate("WGlO2","gNTj6i7bKl");
await instance.addCandidate("dZ5N3","czYgW5JG4v");
await instance.addCandidate("I5qix","OsLNF1oB96");
await instance.addCandidate("HGMXx","cjopKgAsQY");
await instance.addCandidate("JZ2lg","Wm8V29aueC");
await instance.addCandidate("PBptF","lbhA5uZFQM");
await instance.addCandidate("682En","0axtL6iD7S");
await instance.addCandidate("O6ctF","fPQ2ZIwYxL");
await instance.addCandidate("ys7op","kCQic4GlnT");
await instance.addCandidate("iC3Zf","v5kwpxOTcG");
await instance.addCandidate("HJ0X8","Qlycuw9mBo");
await instance.addCandidate("bWSsw","pc29WAhXIT");
await instance.addCandidate("MFEo7","oiwtKnDVmY");
await instance.addCandidate("e3GYT","ibjkYyBZzQ");
await instance.addCandidate("MQua7","fDieEnxmru");
await instance.addCandidate("dhpLN","HpJkzxQwhv");
