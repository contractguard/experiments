...
it('test 0',async() => {
await instance.addCandidate("Hbqs1","5pYrdjgIlA");
await instance.addCandidate("TFsSu","i9kAZjbr3v");
await instance.addCandidate("B6N5a","GQh27sZfE3");
await instance.addCandidate("zr3jA","sEnZwrDvXe");
await instance.addCandidate("6CjWh","mfk8NvV2aX");
await instance.addCandidate("9knmX","79jKGyPdxk");
await instance.addCandidate("fWbMv","QXjiYI4bA3");
await instance.addCandidate("Z72al","d9UyTaZnSu");
await instance.addCandidate("mPy8B","aPUAT1y4CW");
await instance.addCandidate("WjXym","yUjLhBH3J2");
await instance.addCandidate("xgLZH","trokqUDlBZ");
await instance.addCandidate("FcXjH","xoLbB2dRQz");
await instance.addCandidate("u34RZ","xZQ8f3hDMV");
await instance.addCandidate("9i07V","wIh8JUNQvS");
await instance.addCandidate("milhy","ouF4lcDUYx");
await instance.addCandidate("5QgtU","98yJodUMzR");
await instance.addCandidate("GyNtS","m30at7d6oA");
await instance.addCandidate("WNsb9","rtnIf0wc73");
await instance.addCandidate("AhrCB","ibtFyIEKTl");
await instance.addCandidate("hpEt0","HdKDRZNFch");
