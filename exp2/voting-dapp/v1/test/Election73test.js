...
it('test 0',async() => {
await instance.addCandidate("hUKRi","dOzs29CEkg");
await instance.addCandidate("1cBgj","0XOkvu3UjJ");
await instance.addCandidate("2yaNE","Wg9Iiho5a8");
await instance.addCandidate("benWi","vWaz3Jf1XD");
await instance.addCandidate("0E7Fc","oj8HRkNTPi");
await instance.addCandidate("imkzp","HkS4pA9ah2");
await instance.addCandidate("vjtGF","SmGdOY15KP");
await instance.addCandidate("QB5EI","26JFvmpVjE");
await instance.addCandidate("Jsaml","Ax4sWi57hc");
await instance.addCandidate("LvzgW","hmOMfsz3c9");
await instance.addCandidate("gUkSW","xXVW1vKD2O");
await instance.addCandidate("Ipd8Z","zIpTLM6w2g");
await instance.addCandidate("3pm9Z","HRmaqIeVpG");
await instance.addCandidate("YQU9e","fKjV4WkqdF");
await instance.addCandidate("mW4Ou","efOC4Jis7R");
await instance.addCandidate("xMW4w","faL6yekcuO");
await instance.addCandidate("QH6ou","U85VlQHhKD");
await instance.addCandidate("QifWy","i3ZP6z1uvB");
await instance.addCandidate("30hm2","G2Vh5RjsYE");
await instance.addCandidate("Lrje8","8to37gwuTR");
