...
it('test 0',async() => {
await instance.addCandidate("gYTX3","3mvnbXMxjL");
await instance.addCandidate("85Sh7","fzaOFbCRcB");
await instance.addCandidate("XkU9E","CaUNporbGy");
await instance.addCandidate("sZ2wX","yFGI1TDZc2");
await instance.addCandidate("280qE","CYgxK7ptH2");
await instance.addCandidate("eD8Qp","CvopIDRK0x");
await instance.addCandidate("0zUaV","jHu2ZSklnG");
await instance.addCandidate("lwUuk","yolfUqbzF1");
await instance.addCandidate("luraR","ohAVSsZN0R");
await instance.addCandidate("POAxQ","B6uo8EZlFU");
await instance.addCandidate("kBnU2","SKIzolUua1");
await instance.addCandidate("AFyu0","A2QLOCaTn6");
await instance.addCandidate("gJKr9","4e1IhRNWUm");
await instance.addCandidate("iSFOB","nHeZaq7zpK");
await instance.addCandidate("0356k","9z7ZJMxy2t");
await instance.addCandidate("1ME4L","CuItceZaKD");
await instance.addCandidate("vAQjI","JVIru0y6LH");
await instance.addCandidate("DLqvk","mD78ptAyBb");
await instance.addCandidate("9N6da","wVFe6SCu40");
await instance.addCandidate("tJNpW","TIe8luxWtE");
