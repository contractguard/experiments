...
it('test 0',async() => {
await instance.addCandidate("f2awc","hwdc5X3ISA");
await instance.addCandidate("eHayx","HDcmvygVMe");
await instance.addCandidate("pyEiv","bOWgNfaAoy");
await instance.addCandidate("9Y37y","pJucW6GIvs");
await instance.addCandidate("wzKM8","UdSMxOrite");
await instance.addCandidate("3EChx","XgBrWNkoAt");
await instance.addCandidate("WNi2Y","yGnAelm3w6");
await instance.addCandidate("cTymD","aPy8KoiZR0");
await instance.addCandidate("r0Bck","xHpiBgGjcP");
await instance.addCandidate("Wlbxy","f1e3tMCmE0");
await instance.addCandidate("JNHt5","0tA47xEZwD");
await instance.addCandidate("dz3js","cwysGjbqKX");
await instance.addCandidate("7feRM","h5QfTvJ4XP");
await instance.addCandidate("LN2rF","oAMLVH36rp");
await instance.addCandidate("jILas","NYOvhgQzWt");
await instance.addCandidate("LN74C","rJpkoKUeE5");
await instance.addCandidate("Muf2G","d7wgtLpTmn");
await instance.addCandidate("s72ph","WwFdDysUTK");
await instance.addCandidate("a6hso","4FA31OTsSC");
await instance.addCandidate("sExQ7","ZPhaXfTOGk");
...
await instance.vote(10,{from:accounts[6]});
