...
it('test 0',async() => {
await instance.addCandidate("b27fD","lY9jK1VUIs");
await instance.addCandidate("VwqdD","ZePDtwYmgR");
await instance.addCandidate("970yH","iv7zsmunVD");
await instance.addCandidate("VI7c9","uHKQepIOJr");
await instance.addCandidate("0o2gy","oWgx3CFHS5");
await instance.addCandidate("goiWL","gYtHDmrA3v");
await instance.addCandidate("6ITKH","Z6KUElRsxF");
await instance.addCandidate("bOQVI","mrhHO2l84W");
await instance.addCandidate("NeSYu","w3A29cifIQ");
await instance.addCandidate("qcTUJ","n7MKRsQZbC");
await instance.addCandidate("F0wnr","Sc3GrsgWjK");
await instance.addCandidate("3HRjs","U7wAoS8vOC");
await instance.addCandidate("LHJIg","3iw0AfSsnH");
await instance.addCandidate("cXLIZ","UIu1W5rKLG");
await instance.addCandidate("AuBOZ","QJbkMnrEYK");
await instance.addCandidate("L083y","NVujCg2UPX");
await instance.addCandidate("Xod6U","fvuMq5H1LX");
await instance.addCandidate("A3Xpe","AxUThYu0eg");
await instance.addCandidate("PpIGl","gIrLtx6OV5");
await instance.addCandidate("JP6vh","gD7Qkwq8t5");
