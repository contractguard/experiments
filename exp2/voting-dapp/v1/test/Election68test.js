...
it('test 0',async() => {
await instance.addCandidate("qhMOL","cBAoYpUkrX");
await instance.addCandidate("H3W0c","bRJQxTqutz");
await instance.addCandidate("TJsal","Dwirl5f01W");
await instance.addCandidate("P39Nj","4LloICXrMS");
await instance.addCandidate("HuDNz","wc14GCKvTB");
await instance.addCandidate("yFuIh","sL3gEWKcHJ");
await instance.addCandidate("GXFAQ","WdvZ0UY71I");
await instance.addCandidate("VW04x","UBXtaAC7Nx");
await instance.addCandidate("nGrAb","s7wpvmHCLX");
await instance.addCandidate("lK8Qk","6EbtvcYQMK");
await instance.addCandidate("c7EnY","PbdZpONAYB");
await instance.addCandidate("eB3dw","i7YfNlI3yn");
await instance.addCandidate("zoAqe","ATVmxeWD9n");
await instance.addCandidate("Fd3oN","TV3tWGsSCo");
await instance.addCandidate("OSZLY","IXbCQ1nxEf");
await instance.addCandidate("xoUmY","qnWFO8utfy");
await instance.addCandidate("BjuAt","wGN5sMbeag");
await instance.addCandidate("Q1vHf","cJYp1mniKR");
await instance.addCandidate("jBQa1","rzw5OHWalk");
await instance.addCandidate("aq4xI","OpZ1bS2WMl");
...
await instance.vote(10,{from:accounts[33]});
...
await instance.vote(11,{from:accounts[3]});
