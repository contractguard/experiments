...
it('test 0',async() => {
await instance.addCandidate("UJKdl","DF5mhxgvsU");
await instance.addCandidate("oBlpi","RtrDZs1ewi");
await instance.addCandidate("kzW4w","3waOpXIF8B");
await instance.addCandidate("rTESu","9QbSdxpFiV");
await instance.addCandidate("xmpgy","wkWM8XgABx");
await instance.addCandidate("s1OUn","pIuwCrj8c0");
await instance.addCandidate("4bH0M","n68I19dSLy");
await instance.addCandidate("6mAcu","DVOUzjT0te");
await instance.addCandidate("UvLjk","fMJ3F0sNzx");
await instance.addCandidate("3QGmu","RFKb9fAg6t");
await instance.addCandidate("RX1Fh","kKbZYE4AG0");
await instance.addCandidate("QbtF0","CAOGhkKgXR");
await instance.addCandidate("YZ0Bv","yS5Qeh2D47");
await instance.addCandidate("WMqEg","hRdf024Pnq");
await instance.addCandidate("ScLdw","IuKZqxrEl9");
await instance.addCandidate("UfMog","ZSvci3uAzy");
await instance.addCandidate("YfABM","VzOe2PkRSa");
await instance.addCandidate("s09yX","7sj54XyY2Q");
await instance.addCandidate("Ys8Un","pnrbXEMhN4");
await instance.addCandidate("tfD5W","RXzshFfVSZ");
