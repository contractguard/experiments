...
it('test 0',async() => {
await instance.addCandidate("8MVxu","IZ5dSQGCxl");
await instance.addCandidate("wJyYZ","TsAMDBHux4");
await instance.addCandidate("OGtgL","xIEk0vaLlX");
await instance.addCandidate("dn42L","vLqRbe4EV6");
await instance.addCandidate("Yk8Br","RqiHYXl2Qp");
await instance.addCandidate("xi2lj","ConZPjEIU6");
await instance.addCandidate("IiyzM","O2UPS5yXeV");
await instance.addCandidate("bcV2d","stymbK7SRD");
await instance.addCandidate("OZjHt","X2neaD0mfo");
await instance.addCandidate("CMvXn","Fo60gzvysQ");
await instance.addCandidate("LEmcP","VFjyGZmYo1");
await instance.addCandidate("isOzv","y9ksE8ePzL");
await instance.addCandidate("ZqOk0","Rglu2I5jNd");
await instance.addCandidate("9B3vQ","soXNZLq9UE");
await instance.addCandidate("r3gtH","PIVQyuDRoE");
await instance.addCandidate("XGgPU","TDSX1Wq7Mf");
await instance.addCandidate("2w6Oa","CRzvlX4FMG");
await instance.addCandidate("HRwqb","O8lKboFw31");
await instance.addCandidate("l2rp1","YvwzG4AWI7");
await instance.addCandidate("kdIZM","w45Nm7v1Hc");
