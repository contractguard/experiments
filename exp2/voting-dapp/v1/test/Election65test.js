...
it('test 0',async() => {
await instance.addCandidate("R4P2Q","wPYmOeV9cb");
await instance.addCandidate("wxOiy","7aePh4OcuK");
await instance.addCandidate("sauCl","CU4L81fmtX");
await instance.addCandidate("YyniX","Gm9waohx4t");
await instance.addCandidate("1R8Qh","NmoFiWE6ny");
await instance.addCandidate("xgtCj","fwIhHJ1ELW");
await instance.addCandidate("wWqPl","tqDdnYpxSU");
await instance.addCandidate("RGiVX","Bd3mwt21na");
await instance.addCandidate("iA9nS","7lkJiSFgbt");
await instance.addCandidate("JS10e","cmoisXtefx");
await instance.addCandidate("F1C3i","uMUGWpfKdm");
await instance.addCandidate("WYe3v","pGRd1PolS8");
await instance.addCandidate("y6MIW","Irj6YGswMJ");
await instance.addCandidate("M83Oo","hE2ymJDMY9");
await instance.addCandidate("M0GdT","8qUPIm0wue");
await instance.addCandidate("8Y9GD","hlOpcbusM2");
await instance.addCandidate("Z6Asv","v6f901muE8");
await instance.addCandidate("sdUbm","Sp8TjkYsEH");
await instance.addCandidate("1BIRi","tnoVlYbIG6");
await instance.addCandidate("t7i6u","3OXwZCGfKI");
...
await instance.vote(3,{from:accounts[45]});
