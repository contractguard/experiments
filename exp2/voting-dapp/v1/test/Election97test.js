...
it('test 0',async() => {
await instance.addCandidate("vaqZ0","SX65vx9Vak");
await instance.addCandidate("pgVtv","Yf2nVu01DJ");
await instance.addCandidate("jkF8a","dLhe6wbqRT");
await instance.addCandidate("Jm1aq","fEypRUoYs3");
await instance.addCandidate("VWvGH","9yKx31eOF5");
await instance.addCandidate("bmGO9","yVHYMr1Wbd");
await instance.addCandidate("OaVtl","s6Imo4SGnt");
await instance.addCandidate("MBt3F","n0RaE8rS1k");
await instance.addCandidate("GKRJ0","umAt3aMjJB");
await instance.addCandidate("wdhxB","t5w4A0x9Rb");
await instance.addCandidate("lIuT6","bwvtUO5KX2");
await instance.addCandidate("nRSge","vuyLA7ezsW");
await instance.addCandidate("RNwyP","7PukbRKcGi");
await instance.addCandidate("UEzYS","l5zk6REdL2");
await instance.addCandidate("V6BHT","vuRSz0efQP");
await instance.addCandidate("MoQgl","nxr9EafTZC");
await instance.addCandidate("xdvOg","jebCY1ilc5");
await instance.addCandidate("8ciC2","VoJmzNw0jk");
await instance.addCandidate("0bAko","B5TQ7wL1Xc");
await instance.addCandidate("9fpDR","9P1BfwO3H2");
