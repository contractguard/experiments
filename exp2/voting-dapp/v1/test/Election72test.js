...
it('test 0',async() => {
await instance.addCandidate("hqOIY","cZUtnMXiWm");
await instance.addCandidate("kVJMx","k2hBlKJCM7");
await instance.addCandidate("NLyXJ","HzvKyfrUbd");
await instance.addCandidate("JpIor","mBM0EypGuc");
await instance.addCandidate("Z8gPr","bywThsPi1g");
await instance.addCandidate("qedU2","FzpGXk7NCJ");
await instance.addCandidate("PgSwu","rQsVuodfxn");
await instance.addCandidate("02TD7","RXwODmVdFu");
await instance.addCandidate("5r1Ni","GzhxTJlDn9");
await instance.addCandidate("86ErJ","M37RLnSCyD");
await instance.addCandidate("q8iaQ","MG5dl4njwu");
await instance.addCandidate("qrW7O","PlzU67ehm5");
await instance.addCandidate("SjK2p","EVg5XTvRze");
await instance.addCandidate("9ltJb","aGYlQTRtNm");
await instance.addCandidate("dXvEM","eIi4JrTV58");
await instance.addCandidate("FDezC","NoIWGOdLj5");
await instance.addCandidate("GVsB1","iTjWt0Rlk4");
await instance.addCandidate("lXWiy","Jj0y1S4rMZ");
await instance.addCandidate("Z98Gn","F3ivzJPuh0");
await instance.addCandidate("n5Q2y","oVvFqILGsf");
