...
it('test 0',async() => {
await instance.addCandidate("tn7F8","RSN29Wbple");
await instance.addCandidate("kDstd","KiRuZhfGIe");
await instance.addCandidate("9OI0g","q145THrmCP");
await instance.addCandidate("TbDrs","8i7ZXAoDxk");
await instance.addCandidate("9zZ2x","0zT7UwhMKV");
await instance.addCandidate("QMLIE","7LzbvVycdA");
await instance.addCandidate("Sf59l","6lCt4fxWqa");
await instance.addCandidate("OnyPe","m7RHekEfhq");
await instance.addCandidate("nDahx","GMIotbFW3q");
await instance.addCandidate("jC62E","PUqZzyB73x");
await instance.addCandidate("CnF2u","y193ebj6hW");
await instance.addCandidate("QZIJm","wKB9mSPEVI");
await instance.addCandidate("xb39c","t5apMrs6Fm");
await instance.addCandidate("iTq6s","Pa27ndEkg0");
await instance.addCandidate("1U8AY","ZsmHCUVOYz");
await instance.addCandidate("nGvaz","874ZrFbSwl");
await instance.addCandidate("gjzFd","B6Ml90Qezq");
await instance.addCandidate("UNSFC","oKgjSzFVA9");
await instance.addCandidate("q7L8u","DmNRwSPqAE");
await instance.addCandidate("7Dtkm","U7j8N3zPBb");
