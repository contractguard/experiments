...
it('test 0',async() => {
await instance.addCandidate("Ux3iY","sxuRpGNZLj");
await instance.addCandidate("tvNUa","NhleinrYSA");
await instance.addCandidate("TIChn","RTF4nkLPC9");
await instance.addCandidate("2YWST","RhFxaTSPzD");
await instance.addCandidate("596CV","eLBSHC2Jr8");
await instance.addCandidate("soj97","hMucNTS510");
await instance.addCandidate("qIjUk","tUPKROAxeW");
await instance.addCandidate("kuXIa","Mk8j0V5aIt");
await instance.addCandidate("Ny084","g8E0GX4yfi");
await instance.addCandidate("UAYvX","Z7GJf3lvH8");
await instance.addCandidate("tzfxL","zAfbJt8yv3");
await instance.addCandidate("Q6uxv","yXP8swEaCF");
await instance.addCandidate("B9Hyp","BYOZWlF20E");
await instance.addCandidate("v5t7A","FOksCe3bl9");
await instance.addCandidate("LgkHm","TkZOuPR1cF");
await instance.addCandidate("r3QYN","SkunzKq2ho");
await instance.addCandidate("SRzct","AnPRLq6jDo");
await instance.addCandidate("RiplA","tuSJCYRKPI");
await instance.addCandidate("BQvW3","cRqYTFsVBA");
await instance.addCandidate("gVT4G","1OJgqhfpP8");
