...
it('test 0',async() => {
await instance.addCandidate("gT20R","weBMC8AYsG");
await instance.addCandidate("TYCst","EPiDqlFCRb");
await instance.addCandidate("0ZV9J","alGEjUvHVf");
await instance.addCandidate("z2f6n","4IxDL7XF5j");
await instance.addCandidate("bsvUg","QjSviIkHfg");
await instance.addCandidate("lPtUL","bVIpkinTPc");
await instance.addCandidate("MbLWj","UrAz904k8w");
await instance.addCandidate("N3pxc","t9NdlUCHET");
await instance.addCandidate("9RKWj","xvYcBAZh8w");
await instance.addCandidate("t6a4J","c264W5fPKq");
await instance.addCandidate("REMla","8wFYoWjzHU");
await instance.addCandidate("Ym5gL","VYvmoBlFJh");
await instance.addCandidate("Dx3lw","dfteX9ibyz");
await instance.addCandidate("8Rrl1","kXzvO5mnVS");
await instance.addCandidate("DMBhj","9M85g3iOAx");
await instance.addCandidate("vZRx9","xK5hSpoTLl");
await instance.addCandidate("SvVrd","zBWodMnfgI");
await instance.addCandidate("7FaVR","cZK4dwl5Tf");
await instance.addCandidate("XG803","aWFey4p8Kj");
await instance.addCandidate("ZRefS","ufbc6xO2rD");
