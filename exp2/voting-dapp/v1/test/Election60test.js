...
it('test 0',async() => {
await instance.addCandidate("CRLdu","6BKNTgsdye");
await instance.addCandidate("HXKmf","sP6yIYKWTh");
await instance.addCandidate("KEnwo","1hA6PXnoVJ");
await instance.addCandidate("TmaAf","jO67cygamP");
await instance.addCandidate("BKcSZ","IG01Kk3JAv");
await instance.addCandidate("9tTb0","GETH2kCfZr");
await instance.addCandidate("4TwCf","kbZFVDy274");
await instance.addCandidate("f0EtW","aopFqBJLxZ");
await instance.addCandidate("PHZlU","OyUlXajTtr");
await instance.addCandidate("pKHU2","68FRI5zHJc");
await instance.addCandidate("ow7Ub","ewZBipoKcg");
await instance.addCandidate("4XVaY","eVH9QqmRKd");
await instance.addCandidate("Nmqyr","6AQzxDMf83");
await instance.addCandidate("ST71g","epWhRs4ZQ6");
await instance.addCandidate("Hx6U7","tuDqZyPjnk");
await instance.addCandidate("cJGKg","AEkeZT0GI1");
await instance.addCandidate("oQ7Nu","KWVwJqT6DL");
await instance.addCandidate("Rh5ol","QOF4jkiNlK");
await instance.addCandidate("nXibs","LPI3H8q4at");
await instance.addCandidate("GxgLD","JkrgzZL5vF");
