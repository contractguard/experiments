...
it('test 0',async() => {
await instance.addCandidate("wgtnU","U94EbefumP");
await instance.addCandidate("UxMzE","qoxVvUIf7A");
await instance.addCandidate("wjO5D","GlhkAOLcSb");
await instance.addCandidate("rfayL","gzDx1ANPKS");
await instance.addCandidate("OLV96","SwChJQVlDv");
await instance.addCandidate("7wobn","ms7SX3JG1w");
await instance.addCandidate("IcFsQ","4HAQMkw28i");
await instance.addCandidate("SfgQb","jtoX8hDOPa");
await instance.addCandidate("PnTEV","H7OzKcMoFy");
await instance.addCandidate("FICBX","yGpOSLwgXW");
await instance.addCandidate("2V30p","hAZ1Gq3OJk");
await instance.addCandidate("ajBsu","k8pNdE4iIH");
await instance.addCandidate("w9cjr","PWv3BQ5nhe");
await instance.addCandidate("Cpsmc","LNbfAwTshi");
await instance.addCandidate("eZrjw","W6ukrLhJIG");
await instance.addCandidate("Rqxd3","JH8TQkUC2v");
await instance.addCandidate("3ALYo","7L34wHynfW");
await instance.addCandidate("f3Vq2","kENPpV3Thg");
await instance.addCandidate("zYCOR","vV7FuJbyYQ");
await instance.addCandidate("ozDxh","OTBg2aLpcP");
