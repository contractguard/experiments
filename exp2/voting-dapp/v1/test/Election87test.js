...
it('test 0',async() => {
await instance.addCandidate("3U2Xj","sdcr1PaznA");
await instance.addCandidate("ZoY5T","N3MWAP9JFo");
await instance.addCandidate("VWlLX","M1mFXDrluw");
await instance.addCandidate("l4PnU","vxIHaWyQLu");
await instance.addCandidate("BClmR","1zTr2pFRL6");
await instance.addCandidate("SNGJZ","jpPIXQEx4R");
await instance.addCandidate("4KOWL","u9jw6I35vo");
await instance.addCandidate("lU231","xWNvEPkVKe");
await instance.addCandidate("MNjVU","ViPF7m0Ay5");
await instance.addCandidate("vF8f1","EV9t4SzNp5");
await instance.addCandidate("UbgO0","2VuTqS6Ypw");
await instance.addCandidate("pxCLe","HIUzLNAeqv");
await instance.addCandidate("qdYbI","TbYpcFhZeX");
await instance.addCandidate("cXACN","fFupXyIhWR");
await instance.addCandidate("pvhzE","9KOqc03WAZ");
await instance.addCandidate("flXOU","xfOqAandZR");
await instance.addCandidate("yKmkq","qE03PoHFjw");
await instance.addCandidate("CWpHD","5b7IEjlsJc");
await instance.addCandidate("butS1","u9VwgvQa0E");
await instance.addCandidate("EF90M","Eem3rasLqP");
