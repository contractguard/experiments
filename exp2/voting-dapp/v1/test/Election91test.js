...
it('test 0',async() => {
await instance.addCandidate("3vpXL","5EZ2U8JnQt");
await instance.addCandidate("tpHdY","ytJSV6Xn0i");
await instance.addCandidate("8gyHt","BpMiUy6IQC");
await instance.addCandidate("A4LVC","5GafLosjPe");
await instance.addCandidate("3JQNj","UxSJIdtAhF");
await instance.addCandidate("bD4Yr","TNga6ocwEs");
await instance.addCandidate("CZluh","fC1AZ0d7uc");
await instance.addCandidate("emEPC","3lC4inxQvB");
await instance.addCandidate("FNhba","UMS2ztJyY0");
await instance.addCandidate("c5PUW","NnZaqRd1Du");
await instance.addCandidate("7XZeH","dARYqHFZ8f");
await instance.addCandidate("ZDB2t","21WOchlfEv");
await instance.addCandidate("ZGVri","QNAbLYUGw9");
await instance.addCandidate("yLY1J","mH8gVE7Chw");
await instance.addCandidate("fB3su","dkjoNTvhbn");
await instance.addCandidate("DtMn7","0uhgyGb9Hc");
await instance.addCandidate("GlKnC","VmZtl61Ge0");
await instance.addCandidate("qar3M","Y95PimwVpq");
await instance.addCandidate("L0eON","mMLpsIGWfx");
await instance.addCandidate("rGgMq","ChJ42BQqng");
