...
it('test 0',async() => {
await instance.addCandidate("6to8y","2nxV0EtoDM");
await instance.addCandidate("Vde9u","bcBeH76EtR");
await instance.addCandidate("xpSM6","Hy3C1DdSrQ");
await instance.addCandidate("l5FvS","8TGAt04Wub");
await instance.addCandidate("dVUMk","HQZseowjhD");
await instance.addCandidate("7xBpq","whDXTVnsAc");
await instance.addCandidate("1kKmH","MqB6d2A8kw");
await instance.addCandidate("3h9lQ","wHiofIl0dk");
await instance.addCandidate("MKcqA","Fbl7sX4yVh");
await instance.addCandidate("62IlD","rmjHVLgN2a");
await instance.addCandidate("fU04I","DW1eqO67BP");
await instance.addCandidate("e5Vfr","WmRonIQlpY");
await instance.addCandidate("2KqSW","tLqrls2Sdc");
await instance.addCandidate("EoKtz","O0VnXhuQwK");
await instance.addCandidate("OcY6j","3bNVREzpA4");
await instance.addCandidate("aXDyR","mLxRJtnXeY");
await instance.addCandidate("HJedk","xMjcVhlmvD");
await instance.addCandidate("iU5H4","kyDhxacTYC");
await instance.addCandidate("eiXqY","fXVO2BetWD");
await instance.addCandidate("QiTyt","an9cBfEj42");
