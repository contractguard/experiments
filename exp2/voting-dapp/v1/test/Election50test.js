...
it('test 0',async() => {
await instance.addCandidate("d6wJg","pdWFZRyEwQ");
await instance.addCandidate("xuqnH","lViq5fbwA6");
await instance.addCandidate("30zhN","IA2kYwQoNz");
await instance.addCandidate("1qAOy","NwUpFtqZ6o");
await instance.addCandidate("B25tI","JkoMjOeSZ0");
await instance.addCandidate("xlKne","Jfg9nAFeVW");
await instance.addCandidate("6MrJG","3w6DPoTIlO");
await instance.addCandidate("cYTJB","Um6rWfOgST");
await instance.addCandidate("5wcm0","Pb8M4xgFI9");
await instance.addCandidate("6l13d","zLrSiYID72");
await instance.addCandidate("0sQ34","JXMO7doq5W");
await instance.addCandidate("l7xEQ","jaN9er0xI7");
await instance.addCandidate("iJReq","jfsI9nGkm0");
await instance.addCandidate("I5fLS","ILSjEJMkh3");
await instance.addCandidate("JC8g5","dVHAboC4Zx");
await instance.addCandidate("tmkLs","RkXnO1tfzV");
await instance.addCandidate("VxAjN","LUIgevZyNE");
await instance.addCandidate("BAkgD","gbpSIo0CcG");
await instance.addCandidate("jekBX","cEC9pQLf6J");
await instance.addCandidate("PpQ4S","Ta9B3GwtqO");
