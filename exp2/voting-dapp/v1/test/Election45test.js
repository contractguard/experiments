...
it('test 0',async() => {
await instance.addCandidate("z5KSV","WmaXPKG2IF");
await instance.addCandidate("dkl0g","LgbGTJy4Dh");
await instance.addCandidate("5uiFC","y9dsu3pTMi");
await instance.addCandidate("W9wHo","zHaDGr1pNU");
await instance.addCandidate("kzBcF","NCDuMc0A1O");
await instance.addCandidate("coH9G","4eOlCwdtWr");
await instance.addCandidate("cZ9aY","dSTiQ1kGXe");
await instance.addCandidate("hG3EN","CwmQoLOqjW");
await instance.addCandidate("uf7ds","tokZWcVsC3");
await instance.addCandidate("9sEAv","2CWYERVfad");
await instance.addCandidate("feVYU","WS1jQkznwh");
await instance.addCandidate("yUWSJ","Q6ab0eVA18");
await instance.addCandidate("bXHvT","UO6fsPJ8WF");
await instance.addCandidate("ZRyzN","aC1jwn8sJ9");
await instance.addCandidate("kSqUN","Qt9WgM3rKS");
await instance.addCandidate("Yfm8Z","E5NjznbJPG");
await instance.addCandidate("VCThi","caZq4I7Mu5");
await instance.addCandidate("SBM3D","8tZmCdwqXp");
await instance.addCandidate("WjSvr","wkPBv2Hxl8");
await instance.addCandidate("EYqnJ","8puiPfKzLl");
