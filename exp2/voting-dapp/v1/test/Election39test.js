...
it('test 0',async() => {
await instance.addCandidate("qPuam","GiFMYh7vZo");
await instance.addCandidate("LbwtX","JRXUQCtDAs");
await instance.addCandidate("DSBmF","hQLnsDKNOU");
await instance.addCandidate("wgPAr","yNuSksYcZi");
await instance.addCandidate("HuxZd","PBvx8tuapZ");
await instance.addCandidate("YmMbD","HVyNaGXApT");
await instance.addCandidate("OqF86","oiXFEt4NA7");
await instance.addCandidate("YSNTG","lbv9xMP8QB");
await instance.addCandidate("ZKalA","UIGdfC4JRD");
await instance.addCandidate("DjARI","XEZLG3JIKn");
await instance.addCandidate("iAnSo","qNxsTRE3Oo");
await instance.addCandidate("Us90h","e4mYPqj5Hw");
await instance.addCandidate("bUPtq","VPILEgueDU");
await instance.addCandidate("7PyW1","R6fNyTYnqu");
await instance.addCandidate("NM1b2","6oKglT4YCj");
await instance.addCandidate("cBAzN","12KZxEAmRG");
await instance.addCandidate("NP5DS","2BL5cpDECy");
await instance.addCandidate("Z7PLQ","uHrSMYqkAK");
await instance.addCandidate("adFPC","MC6YyHnE2A");
await instance.addCandidate("mSWgF","QtbrxYZnBG");
