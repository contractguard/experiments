...
it('test 0',async() => {
await instance.addCandidate("Ao4Qg","9d5By7wiuz");
await instance.addCandidate("CH4kr","egJ4PzvqFt");
await instance.addCandidate("BFRVv","NJQntk3Wie");
await instance.addCandidate("ehVs3","zl5MPW0kV2");
await instance.addCandidate("xHepq","dDPftXTBOi");
await instance.addCandidate("QOrSw","l2kGNxuPm9");
await instance.addCandidate("f0bcr","B7GQkVRyT0");
await instance.addCandidate("naHXj","jStyn30rve");
await instance.addCandidate("t9G2x","zkno4WsfcO");
await instance.addCandidate("wkFGn","6qNC2cu4Gh");
await instance.addCandidate("c75hq","eS8XgEoHM9");
await instance.addCandidate("2qu34","YpVKPRCgAX");
await instance.addCandidate("SIMDn","S7EUBOg9Hf");
await instance.addCandidate("pdm6I","ivzd4f2aPG");
await instance.addCandidate("mxdyH","r27Cdyjh6L");
await instance.addCandidate("NhBJU","seYlQEFwVG");
await instance.addCandidate("LPZgk","6AWXBV5Qz7");
await instance.addCandidate("eCRbu","ZgYWHrwhcR");
await instance.addCandidate("6Gh5I","ahvpe2yQTS");
await instance.addCandidate("sg47R","ErQSJ95jOn");
...
await instance.vote(9,{from:accounts[16]});
