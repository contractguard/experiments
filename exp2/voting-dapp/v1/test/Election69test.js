...
it('test 0',async() => {
await instance.addCandidate("4ayvp","py3T2OFi9C");
await instance.addCandidate("Yvesa","AOnsuzdeNT");
await instance.addCandidate("kKHhi","3jh4RdD6ov");
await instance.addCandidate("BvSns","V0sc5eqHdr");
await instance.addCandidate("FDTX2","ti4ETkXcfF");
await instance.addCandidate("4xOmq","weKQCDxGFU");
await instance.addCandidate("uHVGB","zhZt2jTSgR");
await instance.addCandidate("2LRnf","YxjU1gmXRS");
await instance.addCandidate("04o32","HW4BVLo7d1");
await instance.addCandidate("jZetk","wusZjqBp6Y");
await instance.addCandidate("Ncot0","UZTfGqdFsr");
await instance.addCandidate("AsFVx","9ufJhHNvzo");
await instance.addCandidate("M7m0s","trso37FLyB");
await instance.addCandidate("RPtDx","36Fs5oZ0Yt");
await instance.addCandidate("8pQeL","bTGoO0XdKj");
await instance.addCandidate("6NLE5","CkZN9W2Syj");
await instance.addCandidate("926CL","X0uMn1wzjP");
await instance.addCandidate("SIzv0","jkbvMZ0fGC");
await instance.addCandidate("Awzjb","B8Flnxd9Lr");
await instance.addCandidate("w7nEJ","Qe8vF0TLfp");
...
await instance.vote(9,{from:accounts[60]});
