...
it('test 0',async() => {
await instance.addCandidate("kORrX","aiXNvM2RQ8");
await instance.addCandidate("F1Cdm","u14V6krqb7");
await instance.addCandidate("5lWzZ","Mr5BfyuUnX");
await instance.addCandidate("iuE0x","xtDSYw6uCI");
await instance.addCandidate("4dNAS","3m6Z0nVHJt");
await instance.addCandidate("VE0S9","ftwbX1lWF7");
await instance.addCandidate("Y5kgL","l7GItTdxKM");
await instance.addCandidate("9vlXb","YxyMkrfwV6");
await instance.addCandidate("SkBz5","0e7DJSVjCN");
await instance.addCandidate("HYji7","SNcIP2qlnM");
await instance.addCandidate("U4jbp","kLPuGgcpf8");
await instance.addCandidate("xIStn","KYrnB10AkW");
await instance.addCandidate("zCDep","atjlm41bJo");
await instance.addCandidate("gJNst","mHZQEXv9Wt");
await instance.addCandidate("AqnTa","pSz03nURIH");
await instance.addCandidate("zn16h","LloyQHzvD8");
await instance.addCandidate("wC6Nr","eysXqpGjAn");
await instance.addCandidate("syf3D","MaI27jRDvG");
await instance.addCandidate("dDltI","uFaf6dQion");
await instance.addCandidate("IdsKW","Mu9UrVYyFD");
...
await instance.vote(13,{from:accounts[51]});
