...
it('test 0',async() => {
await instance.addCandidate("qI9Ko","8jdVf4kWNg");
await instance.addCandidate("zisZ1","VFslgdGJBk");
await instance.addCandidate("8BeCL","KoqkaOfMVw");
await instance.addCandidate("sinR1","oCOStmFUyd");
await instance.addCandidate("gOFHm","syECQcLBvb");
await instance.addCandidate("JCGo5","vkSidW82GK");
await instance.addCandidate("3XAcT","P5acGvIbuh");
await instance.addCandidate("08D5r","M5psvOotfR");
await instance.addCandidate("wT7kf","6KB0zbVQ18");
await instance.addCandidate("7K9Cl","6BIh7U2pZL");
await instance.addCandidate("dnE0P","oZBP2FcL4j");
await instance.addCandidate("tSwIC","jC70qnQcwE");
await instance.addCandidate("X5LgE","Zi74fY2BDp");
await instance.addCandidate("hMEA6","I2soh6MGv1");
await instance.addCandidate("6O2Ru","VWyqsImfn5");
await instance.addCandidate("JGFAc","Gxu3ZAczMP");
await instance.addCandidate("DGXnI","AQs8qK9xfb");
await instance.addCandidate("g7hUQ","LciM51Opk3");
await instance.addCandidate("apVIy","6MJAQiZsxS");
await instance.addCandidate("yoxUl","fK8ZjzbvSc");
...
await instance.vote(2,{from:accounts[46]});
