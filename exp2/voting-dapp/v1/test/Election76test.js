...
it('test 0',async() => {
await instance.addCandidate("T36VM","SfTknQuP9F");
await instance.addCandidate("cW03C","bT152qpY7X");
await instance.addCandidate("PSgpC","sfvElh4J2Q");
await instance.addCandidate("Q3vN0","PpnqROXyjY");
await instance.addCandidate("Vy8jc","Ii9QoCFjOV");
await instance.addCandidate("05Vgl","8fEj2lPdn3");
await instance.addCandidate("VZAuD","tCQMw8KLYJ");
await instance.addCandidate("uXAm8","SFfaG3BLqn");
await instance.addCandidate("ZxJuP","kPbjervtzH");
await instance.addCandidate("TaXWq","C9vtYUKTMQ");
await instance.addCandidate("hzwby","VY2DOSFypz");
await instance.addCandidate("F0Oqg","yCZcoUND4e");
await instance.addCandidate("HMncf","sLfI7GN0rD");
await instance.addCandidate("Kre4q","T4xEsz2enA");
await instance.addCandidate("1gXY9","swxhiCrZ6B");
await instance.addCandidate("VcHFm","xwiWIys3OJ");
await instance.addCandidate("yuOxM","EenaI5hcRB");
await instance.addCandidate("T7R89","GRT9JdMPyS");
await instance.addCandidate("Zr8gF","h7MogzQLpb");
await instance.addCandidate("92IUb","0aZ5YpVfBo");
