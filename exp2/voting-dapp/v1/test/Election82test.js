...
it('test 0',async() => {
await instance.addCandidate("FlGbc","yGAgeRWZfC");
await instance.addCandidate("Iydcp","KH71cjzSl5");
await instance.addCandidate("efEsl","5pPqA8BoVt");
await instance.addCandidate("04bUE","m8xRpi51sk");
await instance.addCandidate("YQncJ","GBNdwmcer7");
await instance.addCandidate("Y1WQV","qWS46MCm7Q");
await instance.addCandidate("Tzs36","nWSebushoi");
await instance.addCandidate("tHN4X","fPl9aV1goZ");
await instance.addCandidate("ZfDpB","BpZUd0SJcy");
await instance.addCandidate("oqaHB","g1meAW6kuX");
await instance.addCandidate("WHQvA","hO9TvSNuor");
await instance.addCandidate("GeRQx","JD2lKFHUd0");
await instance.addCandidate("Z2vi0","cqdR3Qxg5S");
await instance.addCandidate("iOkw3","szuGDnWREL");
await instance.addCandidate("03PvV","abMvuCWDKi");
await instance.addCandidate("JrBuD","oOUIltVJjZ");
await instance.addCandidate("w5lHK","wQI6dHscjM");
await instance.addCandidate("MSpV1","uzVgMYGqo4");
await instance.addCandidate("LlrG8","2KXLevMjzx");
await instance.addCandidate("l8WVb","Wbmgd3oyD8");
