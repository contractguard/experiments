...
it('test 0',async() => {
await instance.addCandidate("7LSda","qbsWYjo0FN");
await instance.addCandidate("dL539","sQU5PgGTu3");
await instance.addCandidate("APY4D","GSvFXICUDe");
await instance.addCandidate("UudjG","NE6rgCV5Qb");
await instance.addCandidate("LbeVc","GrDUdRt8W6");
await instance.addCandidate("Gycwp","J7gyMuHDVL");
await instance.addCandidate("bzXRr","KqBIWGQdwj");
await instance.addCandidate("sgc0B","OMQHXlZr51");
await instance.addCandidate("TtYx8","mctPOQ6jhu");
await instance.addCandidate("7VCtP","uCUi5EedrF");
await instance.addCandidate("LHC9e","XeyrS13EwY");
await instance.addCandidate("GncdF","vFjiOBHxRA");
await instance.addCandidate("UScxT","RoMdX5cC19");
await instance.addCandidate("ou4VF","Y7EMX4K5Zm");
await instance.addCandidate("hwzDP","EvyblQSF2T");
await instance.addCandidate("FLJdW","za2DTCoSqI");
await instance.addCandidate("Ws7fQ","aWCi05Et1U");
await instance.addCandidate("loV7s","ua4vGxmLcX");
await instance.addCandidate("ArKsk","UY0jAuheb6");
await instance.addCandidate("fQ0VK","K6yiH8bnsJ");
