...
it('test 0',async() => {
await instance.addCandidate("0eUkW","7RiFuXTLak");
await instance.addCandidate("RznpJ","FN0X3ubZEa");
await instance.addCandidate("BXn6r","Huy6rfW4xd");
await instance.addCandidate("GFXkP","Dt2YGjINMz");
await instance.addCandidate("Ri2Kd","FQa89oDUtp");
await instance.addCandidate("H8tB7","kTse3cQdbA");
await instance.addCandidate("E2vJX","uoPpqs8bKU");
await instance.addCandidate("AcqgO","m1QvqMcLD6");
await instance.addCandidate("4iJDg","JGcOth6Ebu");
await instance.addCandidate("kOBtS","obwJEQtPiK");
await instance.addCandidate("Pigrw","T1Re3PL7Wm");
await instance.addCandidate("EJSb9","BX6jqGLlda");
await instance.addCandidate("NMaqO","SYFzgVTQCP");
await instance.addCandidate("T9nPU","ge6bP52LmC");
await instance.addCandidate("ZT6kc","jIM25CV6Tp");
await instance.addCandidate("SmTsN","Aavf2g9YQW");
await instance.addCandidate("j3nc6","fZyPCWdjoO");
await instance.addCandidate("HNrxs","WCMGI4ykxS");
await instance.addCandidate("hOfS5","knLA04Dm6y");
await instance.addCandidate("o2aYk","2fwsDu6qVb");
...
await instance.vote(11,{from:accounts[43]});
