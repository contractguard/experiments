...
it('test 0',async() => {
await instance.addCandidate("gwZBm","C47xrI2VFS");
await instance.addCandidate("wQdBX","V10QxmKBOr");
await instance.addCandidate("9NHSW","zSCYot8N2V");
await instance.addCandidate("3odOT","iYqRHg6xvc");
await instance.addCandidate("LvfE8","IXlZHDzwMs");
await instance.addCandidate("lHQu3","qRPsDbAdk6");
await instance.addCandidate("KRtL9","BGz9tfYRkL");
await instance.addCandidate("TcjBX","al8cm0LxPb");
await instance.addCandidate("ik2o5","iL3q7E5hwO");
await instance.addCandidate("4Tgur","ykVeXEbiPG");
await instance.addCandidate("g0VnP","acNAtS5lV7");
await instance.addCandidate("VDFYh","d20aw4Kgnr");
await instance.addCandidate("p9j4K","IkEO4bndg9");
await instance.addCandidate("aDPKz","LaKZY90EdC");
await instance.addCandidate("moUlS","S6QZ59KyEi");
await instance.addCandidate("s8ChX","OzE0UYDmuK");
await instance.addCandidate("QRw8i","i7OeqB6bw9");
await instance.addCandidate("qx4Yo","Fefg41xotU");
await instance.addCandidate("LQM5h","SQpu1qv2HP");
await instance.addCandidate("wrnWN","QdAqtwTZe0");
...
await instance.vote(3,{from:accounts[14]});
