...
it('test 0',async() => {
await instance.addCandidate("XgqQt","sb9iqwgkAo");
await instance.addCandidate("9zVqA","tojlhVqAk1");
await instance.addCandidate("JjF4c","HFV1r5J7Kk");
await instance.addCandidate("a2UWX","wMdUXYua1F");
await instance.addCandidate("QPYhS","lPLHDtrdhb");
await instance.addCandidate("s5zld","ZzhH9IQY8G");
await instance.addCandidate("dTgWc","9SfxHdLUJo");
await instance.addCandidate("lbXJ8","PmbN3gY2KI");
await instance.addCandidate("wQrVl","O8vcfMk7Vy");
await instance.addCandidate("Sr7xF","kR8JBPM4sm");
await instance.addCandidate("21svn","5OJgvx6dfM");
await instance.addCandidate("t7q1m","KZQMHLsk9x");
await instance.addCandidate("m67ZA","RdhU5awWGS");
await instance.addCandidate("EILNF","nfQiFjCX5u");
await instance.addCandidate("pXFN5","SjQKEqhPUv");
await instance.addCandidate("m795d","4F3yfo5Z8B");
await instance.addCandidate("IvbS0","1WHFG7Yhgq");
await instance.addCandidate("z1KTB","8WCTjpN16I");
await instance.addCandidate("AZbFx","Qn9Xo3cigW");
await instance.addCandidate("wI7u4","5QXdjb1scR");
...
await instance.vote(7,{from:accounts[25]});
