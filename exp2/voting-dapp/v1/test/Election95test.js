...
it('test 0',async() => {
await instance.addCandidate("N7XDj","h1U6Ngj3RO");
await instance.addCandidate("Edx2Q","3O9aIMRmlB");
await instance.addCandidate("hN5Ek","YyRlFv13Cz");
await instance.addCandidate("oeaM7","4MKitZxh06");
await instance.addCandidate("QBsr1","uEIOoMvkRe");
await instance.addCandidate("Ew2tO","sHIYf13Tti");
await instance.addCandidate("aln13","IjW6rqDmNX");
await instance.addCandidate("Dkb4L","ymxNZ1DdLc");
await instance.addCandidate("8tnMb","DX9VzGmNIh");
await instance.addCandidate("gUTRJ","NpGxo64z0R");
await instance.addCandidate("CnVyk","kctNdgqDvT");
await instance.addCandidate("bE8rx","6KHgpBJuAj");
await instance.addCandidate("NfFSG","4Bo98uRZ52");
await instance.addCandidate("E42dS","BS6UYgw9Dj");
await instance.addCandidate("91kFZ","vosQjMuJFz");
await instance.addCandidate("Pl2ec","2XJCjieQPD");
await instance.addCandidate("s3AZ5","sm3MoW42cj");
await instance.addCandidate("U4WgR","LNvVTDJiS0");
await instance.addCandidate("ODT5V","OXlf0nJ9b8");
await instance.addCandidate("prsU7","PtAnUe7TB5");
