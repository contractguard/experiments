...
it('test 0',async() => {
await instance.addCandidate("70BiH","qFGSMjNzxw");
await instance.addCandidate("Le0iZ","jdV8C2ft9c");
await instance.addCandidate("SrDuf","68UhzXIKL0");
await instance.addCandidate("0LyRc","SPhLezrXDZ");
await instance.addCandidate("UveFO","f1XcMCKQ4g");
await instance.addCandidate("RlrnQ","XYHodRUeTV");
await instance.addCandidate("JUmPV","YjRdrHW3Tv");
await instance.addCandidate("7nGIa","JFo5HGLe3x");
await instance.addCandidate("2eETW","WCpOuHPcNB");
await instance.addCandidate("4vVbi","JMWOoGgRCQ");
await instance.addCandidate("nSNLl","VdTntWmb31");
await instance.addCandidate("Pn8iG","vks623H8dy");
await instance.addCandidate("cNLj3","632lgU5LFJ");
await instance.addCandidate("WQmn4","TPALqHKvcj");
await instance.addCandidate("YyXAa","jSy7zRMaKW");
await instance.addCandidate("E7rm0","Zmu52dNegb");
await instance.addCandidate("nv0he","wxmjY8SF3i");
await instance.addCandidate("e3W5D","hikyeLSJlP");
await instance.addCandidate("EDBxY","l3bYQ97zZk");
await instance.addCandidate("2HhID","khyaft3ZDW");
...
await instance.vote(3,{from:accounts[37]});
