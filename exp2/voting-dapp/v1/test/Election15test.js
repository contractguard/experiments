...
it('test 0',async() => {
await instance.addCandidate("HDKBa","g03ankxSru");
await instance.addCandidate("zjbyV","oFbXJad9iT");
await instance.addCandidate("yr17T","7pHPU8JcGy");
await instance.addCandidate("yFlck","X8dVHQ6PZF");
await instance.addCandidate("jIqPN","oEjVJycARi");
await instance.addCandidate("N9xAk","aQJi9Ik6E5");
await instance.addCandidate("eONfn","cuFLbIg094");
await instance.addCandidate("gmIUd","ERJ8dXey5T");
await instance.addCandidate("v9mwc","IvbrawjXDG");
await instance.addCandidate("nBiHU","SmZhuMvHLp");
await instance.addCandidate("0cDBb","P3LMv1DzpZ");
await instance.addCandidate("S0QwT","NPh7DLdO5a");
await instance.addCandidate("6tosc","JbDnqL9HtI");
await instance.addCandidate("64dIY","BH15Vfxv3P");
await instance.addCandidate("3HXq1","PxAL51bUI2");
await instance.addCandidate("zcUuK","QFwY0qUErO");
await instance.addCandidate("Rosyu","O3TSgxmnba");
await instance.addCandidate("Udrip","Usq0BpKc6T");
await instance.addCandidate("6McF4","JvPDHAewN5");
await instance.addCandidate("XHhgY","J2t7S3aDCg");
