...
it('test 0',async() => {
await instance.addCandidate("BXQWZ","t1V9RubsMd");
await instance.addCandidate("foFN0","FAYS03uoLq");
await instance.addCandidate("VuXEM","LCc5lPykBt");
await instance.addCandidate("Pp4Gt","e0oK1Dza6f");
await instance.addCandidate("6IGdr","jBGpaXbFS9");
await instance.addCandidate("5rgQT","BXyi8Iw5do");
await instance.addCandidate("DrGAl","KQFYPVd8ku");
await instance.addCandidate("2WJBL","nvLgNxZ9ha");
await instance.addCandidate("nby1v","vIoP5rLQqF");
await instance.addCandidate("PjBl9","Y8QwybqUg4");
await instance.addCandidate("fQcah","e9iZVnkYE2");
await instance.addCandidate("XiCuq","3Rw6fWyZeL");
await instance.addCandidate("INDxM","zSAWwPfnpR");
await instance.addCandidate("QPy4O","s7jXcnudGp");
await instance.addCandidate("VbfrG","QM7Er6ISc1");
await instance.addCandidate("h3Bnk","wXqzuRe26Z");
await instance.addCandidate("Zj62g","7QswvWluzh");
await instance.addCandidate("uBoAX","3cDs5EPwYS");
await instance.addCandidate("KaIM3","0iHa2GJ7CX");
await instance.addCandidate("D2xji","HINBrzXech");
