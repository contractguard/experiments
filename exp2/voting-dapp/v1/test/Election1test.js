...
it('test 0',async() => {
await instance.addCandidate("0Vwlr","b6PgpoYuQ5");
await instance.addCandidate("p3jeL","68JRKe7anL");
await instance.addCandidate("XBwoW","ziCDb3cEaA");
await instance.addCandidate("fzXZw","d2qm3vQkax");
await instance.addCandidate("wgdhu","W3EqoRzhUV");
await instance.addCandidate("prziF","vlQKXY14jh");
await instance.addCandidate("fmaXi","tFg1rbaXmn");
await instance.addCandidate("O7Gly","lWbi7yvOfk");
await instance.addCandidate("TLCQv","MmAoNQJvgt");
await instance.addCandidate("deofJ","0HGikTWucx");
await instance.addCandidate("sEFG8","FoNVGklH17");
await instance.addCandidate("xvmqX","hIQfsUFCtO");
await instance.addCandidate("WPgyk","Aom3JVDlHq");
await instance.addCandidate("GsCNg","FpCraEHvVX");
await instance.addCandidate("DiOcZ","XuFZrAYacC");
await instance.addCandidate("ik1Ez","BU9PbIE0Ki");
await instance.addCandidate("nZ5Up","ZFTqXykLh0");
await instance.addCandidate("V8CIj","31FEad8GwT");
await instance.addCandidate("L78q3","cjXIbs3YW6");
await instance.addCandidate("Yr7Ei","SI5ByMEqnf");
...
await instance.vote(15,{from:accounts[27]});
