...
it('test 0',async() => {
await instance.addCandidate("b90Qs","4AfZOiyeIb");
await instance.addCandidate("qgn0Z","7ufG8OqRYr");
await instance.addCandidate("oLNnH","Cezvdj7YBE");
await instance.addCandidate("KZEpz","9bq4cyHRnl");
await instance.addCandidate("Cf1ge","5Pv1Aiywku");
await instance.addCandidate("3TNqW","miYFtMuUcC");
await instance.addCandidate("1I8lC","NP45xsqhVJ");
await instance.addCandidate("DpUWe","O05nUimP7j");
await instance.addCandidate("Y0b9K","ctOjqh4MSv");
await instance.addCandidate("Nkz0K","7wPvzMiEVk");
await instance.addCandidate("hX0Fn","4GU3fxLt5O");
await instance.addCandidate("UPrTG","vka5cqyJrg");
await instance.addCandidate("gV58D","tPgEaSX0TI");
await instance.addCandidate("VQTIv","ULiaeSItDZ");
await instance.addCandidate("SNdLx","9j126hZViN");
await instance.addCandidate("h5Xw8","e28KbfCZEO");
await instance.addCandidate("RU4iS","coZlL0gEMu");
await instance.addCandidate("wQcOp","pThGgUJ80x");
await instance.addCandidate("AQxsZ","thbdH4wQuW");
await instance.addCandidate("fLSPv","isdRE7qHcA");
