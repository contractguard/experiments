...
it('test 0',async() => {
await instance.addCandidate("lTQzs","3VKbXmBa5J");
await instance.addCandidate("ZEacs","cbMmBsuzYk");
await instance.addCandidate("GpFUu","raYokJ6bNh");
await instance.addCandidate("eM4xW","4Rjl7OnwVe");
await instance.addCandidate("ols5H","qAd4Xmp5JO");
await instance.addCandidate("zvieZ","YRJWHNq5kw");
await instance.addCandidate("r5gPS","skjyF6IJil");
await instance.addCandidate("ivHdS","jHLmR63qh7");
await instance.addCandidate("UOlyr","R2QaZlfMyk");
await instance.addCandidate("bDLda","5U2EbrksnP");
await instance.addCandidate("bAQjE","CoA0t2abKM");
await instance.addCandidate("WES0N","xInJZh4YMX");
await instance.addCandidate("TsWCg","bUZQrNmV89");
await instance.addCandidate("0EwbT","ov04zkhJMG");
await instance.addCandidate("cEKHj","il5b7cIVox");
await instance.addCandidate("LZl0q","Iq8Hn2FsK0");
await instance.addCandidate("y4wtr","XseFilW9K4");
await instance.addCandidate("D8Ni0","QMNB6fh10J");
await instance.addCandidate("vEVPu","1eGoABPCvh");
await instance.addCandidate("NGWy8","eYXGscQSB1");
