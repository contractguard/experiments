...
it('test 0',async() => {
await instance.addCandidate("Mhu5m","gb3Wow7FSY");
await instance.addCandidate("psySa","PujJFU9t2L");
await instance.addCandidate("5mhzx","HlXkojhiI4");
await instance.addCandidate("epk9X","UjJzL2dINl");
await instance.addCandidate("GVYOr","AnlDNkSQeJ");
await instance.addCandidate("56vOH","YvwFWPZnKO");
await instance.addCandidate("AFX4V","tOEJWPmzL9");
await instance.addCandidate("bLwqe","YQdixe27yF");
await instance.addCandidate("7dpHl","fayOmTrAtF");
await instance.addCandidate("6UpLF","vPsaMcjY3T");
await instance.addCandidate("brvDw","mkjhx42Igp");
await instance.addCandidate("fPohF","bKLSgHNedO");
await instance.addCandidate("uTpgV","kIQzVjb7Ae");
await instance.addCandidate("daoVw","a5Op0NmWdx");
await instance.addCandidate("06eAy","DM385nBzyh");
await instance.addCandidate("xgfno","LntirhyefN");
await instance.addCandidate("ev7zT","PUR7SImQgq");
await instance.addCandidate("3V2C8","6idXaeWGFZ");
await instance.addCandidate("XK6Y7","JsoVnKpxiZ");
await instance.addCandidate("9htbx","zm59MK4OhQ");
